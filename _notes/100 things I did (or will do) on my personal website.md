---
title: 100 things I did (or will do) on my personal website
excerpt: <p>Here are the things I plan / would like to do on this website, plus the ones I have already done.</p>
---
Inspired by [100 things you can do on your personal website](https://jamesg.blog/2024/02/19/personal-website-ideas), I've created this list that doubles as a to-do list for this website and a sort of less technical [changelog](https://keepachangelog.com/).
...
- Share a list of web pages (articles, websites, blog posts, photos, games, etc.) you have enjoyed recently.
	- <a href="/open_tabs" class="internal-link">Open Tabs</a>, by far the most active section of this website
- Create an archive page that lists all of the posts on your website.
	- I think <a class="internal-link" href="/garden">The Garden</a> covers that one
- If you want to present your work professionally on your website, add a resume page, written in HTML.
	- could use more work to look more like a resume, but <a href="/professional-experience" class="internal-link">Professional experience</a> covers that
- Create a [now page](https://nownownow.com/).
	- that's exactly what <a href="/now" class="internal-link">/now</a> is about
...
- Make a [guestbook](https://indieweb.org/guestbook) where people can leave notes saying they liked your website.
...
- Add a "[not by AI](https://notbyai.fyi/)" button if your content is all written by you.
...
- Add [sidenotes](https://gwern.net/sidenote) to a blog post.
...
- Add a [holiday theme](https://indieweb.org/holiday_theme) for a day of significance for you.
