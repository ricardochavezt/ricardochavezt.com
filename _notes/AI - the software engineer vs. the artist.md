...
- it is being unnecessarily pushed almost everywhere by people either jumping on the train to not get left behind or people trying to get a quick buck out if it
	...
	- "It occurred to me recently that we are living in a world now where every new email — heck, almost every interaction online — is a [Voight-Kampff](https://bladerunner.fandom.com/wiki/Voight-Kampff_test) test. _Is this a human I’m talking to or a bot? Is this real or is this AI slop?_ It’s exhausting being a [Blade Runner](https://www.imdb.com/title/tt0083658/?ref_=ext_shr_lnk)!" -- Austin Kleon, [10 scraps from my notebook](https://austinkleon.substack.com/p/10-scraps-from-my-notebook)
- there's also the question: why is it going for the creative pursuits? ("AI was supposed to do my laundry so I could have more time to do art, not the other way around")
	- AI was supposed to automate away the "boring" jobs. The problem is that we cannot agree on [[what constitutes a boring job]].
